...
from eff_blip.eff_blip_caption import blip_decoder
import utils
...
def main(args, config):
    ...
    if not args.evaluate:
        model = blip_decoder(pretrained=config['pretrained'], config=config, image_size=config['image_size'],
                         vit=config['vit'], vit_grad_ckpt=config['vit_grad_ckpt'],
                         vit_ckpt_layer=config['vit_ckpt_layer'])
    else:
        model = blip_decoder(pretrained=config['trained'], config=config, image_size=config['image_size'],
                         vit=config['vit'], vit_grad_ckpt=config['vit_grad_ckpt'],
                         vit_ckpt_layer=config['vit_ckpt_layer'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='./eff_blip_configs/eff_caption_coco.yaml')
    parser.add_argument('--output_dir', default='./output/cococap/')
